			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onMouseEnter(_user$project$Main$Decrement),
						_elm_lang$html$Html_Events$onMouseLeave(_user$project$Main$Increment)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onMouseEnter(_user$project$Main$Increment),
						_elm_lang$html$Html_Events$onMouseLeave(_user$project$Main$Decrement)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('+')
